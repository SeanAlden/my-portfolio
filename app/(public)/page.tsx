...
// export default async function Home() {
//   // Ambil semua data secara paralel agar jauh lebih cepat, termasuk 'profile'
//   const [experiences, educations, organizations, projects, rawSkills, profile] = await Promise.all([
//     getApiData('experiences'),
//     getApiData('educations'),
//     getApiData('organizations'),
//     getApiData('projects'),
//     getApiData('skills'),
//     getApiData('profile'), // Fetch data user/admin publik
//   ]);

//   // Statistik Dinamis
//   const totalExperience = experiences.length || 0;
//   const totalProjects = projects.length || 0;
//   const totalTech = rawSkills.length || 0;

//   // Transformasi data Skills dari API agar sesuai dengan UI
//   const groupedSkillsMap = rawSkills.reduce((acc: any, skill: any) => {
//     const categoryName = skill.category?.name || 'Lainnya';
//     if (!acc[categoryName]) {
//       acc[categoryName] = { category: categoryName, items: [] };
...
//             <div className="w-40 h-40 md:w-48 md:h-48 shrink-0 relative rounded-full overflow-hidden border-4 border-white shadow-xl bg-gray-100">
//               <Image 
//                 // Menggunakan image_url dari database, fallback ke default jika kosong
//                 src={profile?.image_url || '/default-project.png'} 
//                 alt="Profile Photo" 
//                 fill 
//                 className="object-cover"
//                 priority
...
//             <header className="space-y-4 text-center md:text-left flex-grow mt-4 md:mt-6">
//               <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight text-white">
//                 {/* Menggunakan name dari database */}
//                 {profile?.name || 'Nama Anda'}
//               </h1>
//               <h2 className="text-2xl font-medium text-blue-600">
//                 {/* Menggunakan role dari database */}
//                 {profile?.role || 'Role Belum Diatur'}
//               </h2>
//             </header>
//           </div>
//         </FadeIn>
...
//             <h3 className="text-xl font-bold border-b pb-4 mb-6 text-gray-900">Professional Summary</h3>
//             <p className="text-gray-600 leading-relaxed text-lg">
//               {/* Menggunakan description dari database */}
//               {profile?.description || 'Deskripsi tentang Anda belum ditambahkan. Silakan atur melalui dashboard admin.'}
//             </p>
//           </div>
//         </FadeIn>
