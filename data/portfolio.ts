...
//       desc: "Sistem autentikasi pengguna, pemesanan kamar, dan pengelolaan data realtime yang efisien.",
//       tech: ["Flutter", "Firebase", "Dart", "NoSQL"],
//       // Array link GitHub agar bisa lebih dari satu
//       githubUrls: [
...
export const personalInfo = {
  ...
  linkedin: "linkedin.com/in/sean-alden",
  instagram: "instagram.com/seanalden7",
  github: "github.com/SeanAlden",
...
export const education = {
  ...
  organizations: [
    {
      name: "Public Lecture about Cyber Security",
      role: "Creative & Documenter",
      period: "Mar 2024 – Mar 2024",
      points: [
        "Designed promotional posters to advertise the Public Lecture event.",
        "Captured photo documentation of key moments during the Public Lecture."
      ]
    },
    {
      name: "Public Lecture about Artificial Intelligence",
      role: "Creative & Documenter",
    ...
    {
      name: "Venture Festival - Technology For Sustainability And Better Future",
      role: "Equipment & Logistic",
      period: "Nov 2023 – Dec 2023",
      points: [
        "Participated as a member of the equipment division in the organization.",
        "Organized the exhibition venue, including arranging chairs, LCDs, stage, and other equipment.",
        "Assisted in managing the consumption (catering) for all committee divisions."
      ]
    }
  ],
  projects: [
